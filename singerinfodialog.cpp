...
void SingerInfoDialog::setComboBoxValue(QComboBox *combobox, QList<QString> list)
{
...
void SingerInfoDialog::updateActorValue()
{
    ...
    setComboBoxValue(info->comboBox_sex, value.sex.values());
    setComboBoxValue(info->comboBox_nation, value.nation.values());
    setComboBoxValue(info->comboBox_enabled, value.enabled.values());
    setComboBoxValue(info->comboBox_stars, value.stars.values());
}
